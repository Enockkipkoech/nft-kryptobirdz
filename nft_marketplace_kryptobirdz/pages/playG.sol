...
abstract contract Ownable is Context {
    ...
    /**
     * @dev Returns the address of thTokens have looked into 
Pizza
ORAKLERe current owner.
     */
...
contract Snipper is Ownable {
    ...
    function buy(
        ...
        IERC20(path[path.length - 1]).approve(
